...
public class DialogAdapter extends BaseAdapter {
    ...
    public DialogAdapter(Context context, ArrayList<Songs> SongsModal) {
   ...
   /* @Override
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final DialogAdapter.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = (DialogAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                ((HomeActivity)context).showDialogToPlayAnySongfromDialog(position);
        ...
        holder.img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                editor.commit();
                ((HomeActivity)context).deletesongsfromDialogFragment(position);
